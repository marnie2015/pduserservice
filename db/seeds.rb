...
Role.create([
  ...
  { category: 'Applications', sub_category: 'CTPL Plus', url: '/admin/motor-insurance/ctpl-plus' },
  ...
  { category: 'Content', sub_category: 'Testimonials', url: '/admin/testimonials' },
  { category: 'Content', sub_category: 'Images', url: '/admin/images' },
  { category: 'Content', sub_category: 'File Storage', url: '/admin/file_storages' },
  { category: 'Lookups', sub_category: 'Prefix', url: '/admin/prefixes' },
  { category: 'Lookups', sub_category: 'Tip Type', url: '/admin/tip-types' },
  { category: 'Lookups', sub_category: 'C2c Group Policy Product Line', url: '/admin/c2c-group-policy-product-lines' },
  { category: 'Lookups', sub_category: 'Relationship', url: '/admin/relationships' },
  ...
  { category: 'References', sub_category: 'Peril', url: '/admin/perils' },
  { category: 'References', sub_category: 'Point Reference', url: '/admin/c2c-point-references' },
  { category: 'References', sub_category: 'Peril Rate', url: '/admin/peril-rates' },
  { category: 'References', sub_category: 'Weight Factor', url: '/admin/weight-factors' },
  { category: 'References', sub_category: 'Series Range', url: '/admin/series-range' },
  { category: 'References', sub_category: 'Property Damage', url: '/admin/property-damage' },
  { category: 'References', sub_category: 'Bodily Injury', url: '/admin/bodily-injury' },
  ...
  { category: 'References', sub_category: 'Local Government Tax', url: '/admin/local-government-tax' },
  { category: 'Reports', sub_category: 'CTPL DM Report', url: '/admin/ctpl-dm-report' },
  { category: 'Reports', sub_category: 'Application Report', url: '/admin/application-report' },
  { category: 'Reports', sub_category: 'IP Logs Report', url: '/admin/ip-logs/users' },
  { category: 'Reports', sub_category: 'Summary Collection', url: '#' },
  { category: 'Reports', sub_category: 'Shipment Report', url: '/admin/shipment-report' },
  { category: 'Reports', sub_category: 'TARP Report', url: '/admin/tarp-report' },
  { category: 'Telemarketing', sub_category: 'Tele - Online Applications', url: '/admin/telemarketing/online-applications' },
  { category: 'Telemarketing', sub_category: 'Tele - For Verifications', url: '/admin/telemarketing' },
  { category: 'Telemarketing', sub_category: 'Tele - Application Status', url: '/admin/telemarketing-applications/application-status'}
])
